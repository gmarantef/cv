...
- **Correo:** {{email}}
- **Teléfono:** {{phone}}
- **Loacalización:** A Coruña, Galicia, España
...
Ingeniero de datos con foco en infraestructura. Diseño y opero pipelines
robustos y arquitecturas escalables, tanto en AWS como on-premise, con atención
al coste, la observabilidad y la simplicidad operativa. Mi valor diferencial
está en entender el dato que corre sobre la infra, no solo la infra.
...
- Contenerización de proyectos DBT y gestión de artefactos en Artifact Registry.
- Configuración de entornos de desarrollo asistido por IA (Cline, GitHub
Copilot).
- Desarrollo de ETLs sobre Snowflake y modelado de datos de marketing digital
(GA4, Search Console).
...
- ETLs en PySpark y consultas SQL sobre BigQuery.
...
- Infraestructura reproducible y modular con Terraform.
- Contenerización de jobs y CI/CD.
- Separación y supervisión de entornos Dev/Prod.
...
- IaC con Terraform: aprovisionamiento, modularización y automatización.
- Data Lake centralizado, pipelines PySpark, orquestación de jobs e integración
vía APIs.
