...
- **LinkedIn:** [guillermomarantefreire](https://linkedin.com/in/guillermomarantefreire)
- **GitHub:** [gmarantef](https://github.com/gmarantef)

---

## Profile

Data engineer with a focus on infrastructure. I design and operate robust
pipelines and scalable architectures, both on AWS and on-premise, with
attention to cost, observability, and operational simplicity. My
differentiating value lies in understanding the data that runs on top of the
...
- DBT project containerization and artifact management in Artifact Registry.
- Setup of AI-assisted development environments (Cline, GitHub Copilot).
- ETL development on Snowflake and digital marketing data modeling (GA4, Search
Console).
...
- PySpark ETLs and SQL queries on BigQuery.
...
- Reproducible and modular infrastructure with Terraform.
- Job containerization and CI/CD automation.
- Dev/Prod environment separation and technical oversight.
- Pipeline monitoring with Datadog.
...
- IaC with Terraform: provisioning, modularization, and automation.
- Centralized Data Lake, PySpark transformation pipelines, batch job
orchestration, and API-based source integration.
...
- Infrastructure as Code Using Terraform · Educative
- Docker for Developers · Educative
- Master the Bash Shell · Educative
- A Guide to Vagrant and Virtual Machines · Educative
